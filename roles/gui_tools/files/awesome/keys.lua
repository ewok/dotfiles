...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "h", function () awful.client.swap.bydirection("left")    end,
              {description = "swap window by direction", group = "client"}),
    ...
    awful.key({ altkey, "Shift"   }, "j",     function () awful.tag.incncol( 1, nil, true)           end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ altkey, "Shift"   }, "k",     function () awful.tag.incncol(-1, nil, true)           end,
              {description = "decrease the number of columns", group = "layout"}),

    -- awful.key({ modkey     }, "b", function () awful.spawn(browser)          end,
    --           {description = "launch Browser", group = "launcher"}),

    awful.key({ modkey,          }, "d", function () awful.spawn.with_shell("albert toggle || albert", {
                  floating  = true, sticky = true, modal = true, }) end,
              {description = "launch albert", group = "launcher"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "p",      function (c) c.sticky = not c.sticky          end,
              {description = "toggle pined", group = "client"}),
